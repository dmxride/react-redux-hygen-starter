---
to: "<%= logic ? shared ? 'src/shared/containers/'+h.inflection.camelize(name.toLowerCase())+'/logic/sagas.ts' : 'src/scenes/' + folder + '/containers/'+h.inflection.camelize(name.toLowerCase())+'/logic/sagas.ts' : null %>"
---
/**
