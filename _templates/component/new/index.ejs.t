---
to: "<%= shared ? 'src/shared/components/'+h.inflection.camelize(name.toLowerCase())+'/index.tsx' :  'src/scenes/'+ folder + '/components/' + h.inflection.camelize(name.toLowerCase())+'/index.tsx' %>"
---
/**
