...
const Dashboard = ({ t, i18n }) => {
  ...
  return (
    <Wrapper>
      ...
      <Buttons>
        <Button onClick={() => { dispatch(setValue('I was called by an Action')) }}>CALL ACTION</Button>
        <Button onClick={() => { dispatch(updateValue()) }}>CALL SAGA</Button>
        <Button onClick={() => { dispatch(navigateTo('settings')) }}>NAVIGATE TO SETTINGS</Button>
      </Buttons>
